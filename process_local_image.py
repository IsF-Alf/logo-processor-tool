...
if __name__ == "__main__":
    ...
    if os.path.exists(input_image):
        # Resize the image
        if resize_image(input_image, resized_image):
            # Save as PDF
            save_as_pdf(resized_image, pdf_output)
    else:
        print(f"Input file {input_image} not found. Please save your logo as 'input_logo.png' in the same folder as this script.")
